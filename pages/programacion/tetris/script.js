...
var Page = {  
  ...
  WindowChanged: function() {
    ...
    var bodyW = document.documentElement.clientWidth,
        ...
        newUnitH = (bodyH - (bodyH % 80)) / 25,
        newUnitMin = Math.max(Math.min(newUnitW, newUnitH), 25);    
    ...
    var topPos = (bodyH - bottomLimit) / 4,
        leftPos = (bodyW / 4) - (this.Game.W / 4),
...
Page.ScoreBarHigh = new DrawAreaObj(10.5,0,4.5,1,function(){
  ...
  text = ("000" + GM.ScoreHigh).slice(-1);
  left = this.left + this.W - 50;
  top = this.top + Page.unitSize * 0.8;
  size = Math.floor(Page.unitSize * 0.8) + 0.4;
